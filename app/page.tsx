...
import { getPulseStats, getTopListings, getOrderTrend } from "@/lib/marketplace-stats";
...
export default async function Home({
  ...
  const [listings, categoryRows, usdPerBtc, pulseStats, topListings, orderTrend] = await Promise.all([
