  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="relative -mx-6 overflow-hidden px-6 pt-2 pb-6 lg:mx-0 lg:px-0">
          ...
          <div className="relative">
            ...
            <h1 className="text-balance font-serif text-4xl leading-[1.05] font-semibold tracking-tighter text-ink sm:text-5xl">
              Give your agent a budget, not a babysitter.
            </h1>
      ...
      <div className="mt-24 border-t border-border pt-16">
        ...
        <h2 className="text-balance text-center font-serif text-4xl leading-[1.05] font-semibold tracking-tighter text-ink sm:text-5xl">
          Connect your agent. Set a budget. Let it shop.
        </h2>
        <p className="mx-auto mt-6 max-w-xl text-balance text-center text-base text-ink-secondary sm:text-lg">
