...
refund. Live at [shop.getnoden.com](https://shop.getnoden.com).
...
`GET/POST/DELETE https://shop.getnoden.com/mcp` — a
...
Resource: `noden://catalog` — the current catalog of active skills, as
